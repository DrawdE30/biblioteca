            ...
            data.forEach(u => {
                ...
                tableBody.innerHTML += `
                    <tr>
                        ...
                        <td>${nombresRoles}</td>
                        <td>
                            <button class='btn btn-success' style="font-size:10px;" onclick='editar(${JSON.stringify(u)})'>✏️</button>
                            <button class='btn btn-danger' style="font-size:10px;" onclick='eliminar(${u.idUsuario})'>❌</button>
                        </td>
                    </tr>`;
            });
        })
